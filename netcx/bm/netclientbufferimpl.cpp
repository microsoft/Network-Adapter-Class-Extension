...
)
{
    ...
    NetCx::Core::BufferPool* pool
        = reinterpret_cast<NetCx::Core::BufferPool *> (BufferPool);
...
{
    auto pool = reinterpret_cast<NetCx::Core::BufferPool*>(BufferPool);
...
)
{
    ...
    wistd::unique_ptr<NetCx::Core::BufferManager>
        bufferManager = wil::make_unique_nothrow<NetCx::Core::BufferManager>();

    CX_RETURN_NTSTATUS_IF(STATUS_INSUFFICIENT_RESOURCES, !bufferManager);

    wistd::unique_ptr<NetCx::Core::BufferPool> pool
        = wil::make_unique_nothrow<NetCx::Core::BufferPool>();
    ...
    NetCx::Core::IBufferVector* bufferVector = nullptr;
