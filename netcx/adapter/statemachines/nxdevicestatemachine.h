...
private:
    ...
    struct EntryFuncs
    {
        ...
        static SmFx::StateEntryFunction ReleasedSelfManagedIoCleanupEntry;
    ...
    struct ExternalTransitions
    {
        ...
        static const SmFx::EXTERNAL_TRANSITION c_releasedSelfManagedIoCleanup[];
        ...
        static const SmFx::EXTERNAL_TRANSITION c_waitForCleanup[];
    };
    ...
    struct SlotArrays
    {
        ...
        static const SmFx::StateSlot c_releasedSelfManagedIoCleanup[];
        ...
        static const SmFx::StateSlot c_waitForCleanup[];
    };
...
template<typename T>
SmFx::EventIndex
NxDeviceStateMachine<T>::EntryFuncs::ReleasedSelfManagedIoCleanupEntry(
    void* context)
{
    auto derived = static_cast<T*>(reinterpret_cast<NxDeviceStateMachine<T>*>(context));

    NxDeviceStateMachine<T>::Event returnEvent = derived->SelfManagedIoCleanup();
...
const SmFx::EXTERNAL_TRANSITION NxDeviceStateMachine<T>::ExternalTransitions::c_initializedWaitForStart[] =
{
    {
        // Triggering event.
        static_cast<SmFx::EventIndex>(NxDeviceStateMachine<T>::Event::CxPostSelfManagedIoInit),
        // Target state.
...
const SmFx::EXTERNAL_TRANSITION NxDeviceStateMachine<T>::ExternalTransitions::c_released[] =
{
    {
        // Triggering event.
        static_cast<SmFx::EventIndex>(NxDeviceStateMachine<T>::Event::CxPostSelfManagedIoCleanup),
        // Target state.
        static_cast<SmFx::StateIndex>(NxDeviceStateMachine<T>::StateIndex::ReleasedSelfManagedIoCleanup)
    },
    {
        // Triggering event.
        static_cast<SmFx::EventIndex>(NxDeviceStateMachine<T>::Event::CxPrePrepareHardware),
...
template <typename T>
const SmFx::EXTERNAL_TRANSITION NxDeviceStateMachine<T>::ExternalTransitions::c_releasedSelfManagedIoCleanup[] =
{
    {
        // Triggering event.
        static_cast<SmFx::EventIndex>(NxDeviceStateMachine<T>::Event::SyncSuccess),
        // Target state.
        static_cast<SmFx::StateIndex>(NxDeviceStateMachine<T>::StateIndex::WaitForCleanup)
    },
    {
        // Sentinel.
        static_cast<SmFx::EventIndex>(0),
...
template <typename T>
const SmFx::EXTERNAL_TRANSITION NxDeviceStateMachine<T>::ExternalTransitions::c_waitForCleanup[] =
{
    {
        // Triggering event.
        static_cast<SmFx::EventIndex>(NxDeviceStateMachine<T>::Event::WdfDeviceObjectCleanup),
...
const SmFx::EVENT_SPECIFICATION NxDeviceStateMachine<T>::c_eventTable[] =
{
    ...
    {
        static_cast<SmFx::EventId>(NxDeviceStateMachine<T>::EventId::CxPostSelfManagedIoCleanup),
        SmFx::EventQueueingDisposition::Unlimited
    },
    {
        static_cast<SmFx::EventId>(NxDeviceStateMachine<T>::EventId::CxPostSelfManagedIoInit),
        SmFx::EventQueueingDisposition::Unlimited
    },
    {
...
template <typename T>
const SmFx::StateSlot NxDeviceStateMachine<T>::SlotArrays::c_releasedSelfManagedIoCleanup[] =
{
    reinterpret_cast<SmFx::StateSlot>(&NxDeviceStateMachine<T>::EntryFuncs::ReleasedSelfManagedIoCleanupEntry),
    NxDeviceStateMachine<T>::ExternalTransitions::c_releasedSelfManagedIoCleanup,
};
...
template <typename T>
const SmFx::StateSlot NxDeviceStateMachine<T>::SlotArrays::c_waitForCleanup[] =
{
    NxDeviceStateMachine<T>::ExternalTransitions::c_waitForCleanup,
};
...
const SmFx::STATE_SPECIFICATION NxDeviceStateMachine<T>::c_stateTable[] =
{
    ...
    // State: ReleasedSelfManagedIoCleanup
    {
        // State ID.
        static_cast<SmFx::StateId>(NxDeviceStateMachine<T>::StateId::ReleasedSelfManagedIoCleanup),
        // State flags.
        SmFx::StateFlags::None,
        // State type.
        SmFx::StateType::Sync,
        ...
        static_cast<SmFx::SubmachineIndex>(NxDeviceStateMachine<T>::SubmachineName::_nosubmachine_),
        // Slot array.
        NxDeviceStateMachine<T>::SlotArrays::c_releasedSelfManagedIoCleanup,
    },
    ...
    // State: WaitForCleanup
    {
        ...
        static_cast<SmFx::SubmachineIndex>(NxDeviceStateMachine<T>::SubmachineName::_nosubmachine_),
        // Slot array.
        NxDeviceStateMachine<T>::SlotArrays::c_waitForCleanup,
    },
};
